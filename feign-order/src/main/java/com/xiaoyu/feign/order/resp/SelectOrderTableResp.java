 ...
 */
@Data
@ApiModel(value = "SelectOrderTableResp", description = "分页查询订单请求接口返回实体类")
public class SelectOrderTableResp extends BaseRespBean {
    private static final long serialVersionUID = -5966833745345960661L;
