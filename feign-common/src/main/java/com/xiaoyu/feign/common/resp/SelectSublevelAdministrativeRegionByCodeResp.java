 ...
 */
@Data
@ApiModel(value = "SelectSublevelAdministrativeRegionByCodeResp", description = "根据行政区域编码获取下级行政区域请求接口返回实体类")
public class SelectSublevelAdministrativeRegionByCodeResp extends BaseRespBean {
    private static final long serialVersionUID = 4161636519437002902L;
