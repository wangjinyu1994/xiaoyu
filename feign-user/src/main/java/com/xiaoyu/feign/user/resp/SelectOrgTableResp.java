 ...
 */
@Data
@ApiModel(value = "SelectOrgTableResp", description = "分页查询机构请求接口返回实体类")
public class SelectOrgTableResp extends BaseRespBean {
    private static final long serialVersionUID = -1901414883773933792L;
