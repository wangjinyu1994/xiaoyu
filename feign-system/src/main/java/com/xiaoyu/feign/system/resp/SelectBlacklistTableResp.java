 ...
 */
@Data
@ApiModel(value = "SelectBlacklistTableResp", description = "获取所有黑名单请求接口分页返回实体类")
public class SelectBlacklistTableResp extends BaseRespBean {
    private static final long serialVersionUID = -425870474492118137L;
