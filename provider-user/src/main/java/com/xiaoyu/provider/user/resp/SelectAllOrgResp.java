 ...
 */
@Data
@ApiModel(value = "SelectAllOrgResp", description = "查询所有机构请求接口返回实体类")
public class SelectAllOrgResp extends BaseRespBean {
    private static final long serialVersionUID = 2566381881972213489L;
