...
@Data
@ApiModel(value = "Xtryjgxxb", description = "系统人员机构信息表")
public class Xtryjgxxb implements Serializable {
    private static final long serialVersionUID = -6609652254396224098L;
    ...
    @ApiModelProperty(value = "系统机构主键", name="xtjgzj")
    private Long xtjgzj;
