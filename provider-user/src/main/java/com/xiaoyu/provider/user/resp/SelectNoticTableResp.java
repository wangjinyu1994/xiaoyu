 ...
 */
@Data
@ApiModel(value = "SelectNoticTableResp", description = "分页查询消息通知请求接口返回实体类")
public class SelectNoticTableResp extends BaseRespBean {
    private static final long serialVersionUID = 6328729611781653269L;
