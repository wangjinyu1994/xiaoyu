 ...
 */
@Data
@ApiModel(value = "SelectRoleResourceTableResp", description = "分页查看角色资源详情请求接口返回实体类")
public class SelectRoleResourceTableResp extends BaseRespBean {
    private static final long serialVersionUID = -8926974540657863732L;
