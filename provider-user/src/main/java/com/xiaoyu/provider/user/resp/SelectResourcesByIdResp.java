 ...
 */
@Data
@ApiModel(value = "AddCoreDetailsInfoResp", description = "根据主键查询资源请求接口返回实体类")
public class SelectResourcesByIdResp extends BaseRespBean {
    private static final long serialVersionUID = -7777166079471533983L;
