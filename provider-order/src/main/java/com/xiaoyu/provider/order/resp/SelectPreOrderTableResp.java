 ...
 */
@Data
@ApiModel(value = "SelectPreOrderTableResp", description = "分页查询预处理订单请求接口返回实体类")
public class SelectPreOrderTableResp extends BaseRespBean {
    private static final long serialVersionUID = -3966537263125401468L;
